            ...
            <header class="bg-gradient-to-r from-[#48A6A7] to-[#006A71] py-4">
                <div class="max-w-7xl mx-auto px-6 flex justify-between items-center">
                    ...
                    <nav class="hidden md:flex space-x-6 text-[#F2EFE7] text-sm font-medium">
                        ...
                        <a href="grade.php"
                            class="hover:text-[#9ACBD0] hover:border-b-2 hover:border-[#9ACBD0] active:border-b-2 active:border-[#9ACBD0] transition-all duration-700">Grade Roadmap</a>
                        <a href="#about"
                            ...
                            <div class="p-6">
                                ...
                                <div class="mb-6">
                                    ...
                                    <ul class="list-disc pl-5 text-gray-600 space-y-1">
                                        ...
                                        <li>Engineer (All Disciplines)</li>
